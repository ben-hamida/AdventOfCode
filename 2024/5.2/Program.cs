...
internal record Update(List<int> Pages)
{
    ...
    public Update Fix(HashSet<Rule> rules)
    {
        Pages.Sort((a, b) => rules.Contains(new Rule(a, b)) ? 1 : -1);
        return this;
    }
}